...
// imprime por consola
const posicion = msg.indexOf("ejercicios")
const palabra = msg.slice(posicion, posicion + "ejercicios".length)
console.log(palabra);
...
console.log(contador_vocales(msg));
